###Intro
This post is a detailed guide on how to scrape the Google News tab on Node.js. I will show you several ways to do this.
...
We will get the name of the source, title and link to the news, publication date, text snippet and image.

###Preparation

First, we need to create a Node.js project and add npm packages "cheerio" and "axios". To do this, in the directory with our project, open the command line and enter:
`npm init -y`
then:
`npm i cheerio axios`
...
```
* pattern - a RegEx pattern for search and define full images;
...
Next, we write in constant what we want to search:
...
* q - our search query;
* google_domain - google domain of the search
...
* tbm - parameter defines the type of search you want to do
...
###Links
[Code in the online IDE](https://replit.com/@MikhailZub/Google-News-Tab-scrape-NodeJS-SerpApi#index.js) • [SerpApi Playground](https://serpapi.com/playground?q=elon+musk&gl=us&hl=en&tbm=nws)
